...
//below function ensures that shape didnot cross the stage boundary while dragging
...
//Below function contains the  logic of points and drawing of shapes
...
//Below function is responsible of eraser logic for shapes and not crossing the stage while drawing
    const handleMouseMove = (e) => {
        ...
        //logic for not crossing the stage area while  drawing
...
//attaching transformer to shape
    useEffect(() => {
...
//cursorstyles while drawing ehich symbol is shown
    const cursorStyles = {
            ...
            >
                ...
                <div className="toolbar h-full w-18 items-center p-2 rounded-xl">
                    ...
                    <button
                        ...
                        className={`p-2 rounded-full ${tool === "text" ? "bg-blue-100" : ""}`}
                    >
                        <FaFont size={20} />
                    </button>
