...
export default function Design() {
  ...
  const handleMouseMove = (e) => {
    ...
    if (tool === "eraser") {
      ...
      for (let i = shapes.length - 1; i >= 0; i--) {
        ...
        if (shape.tool === "rectangle") {
          ...
          erase =
            (point.y >= top && point.y <= bottom && (nearLeft || nearRight)) ||
        ...
        // }
          ...
          erase =
            distance >= shape.radius - eraserSize &&
            distance <= shape.radius + eraserSize;
        }
        ...
        // }
          ...
          erase =
            dist1 <= eraserSize || dist2 <= eraserSize || dist3 <= eraserSize;
        }
        ...
        // }
          ...
          for (let i = 0; i < numSides; i++) {
            ...
            if (
              distanceToSegment(point.x, point.y, x1, y1, x2, y2) <= eraserSize
            ) {
              erase = true;
              break;
            }
        ...
        // }
          ...
          const nearPolyline = (pts) => {
            for (let i = 0; i < pts.length; i++) {
              ...
              if (
                distanceToSegment(point.x, point.y, x1, y1, x2, y2) <=
                eraserSize
              ) {
                return true;
              }
        ...
        // }
          ...
          erase = edges.some(
            ([p1, p2]) =>
              distanceToSegment(point.x, point.y, p1[0], p1[1], p2[0], p2[1]) <=
              tol
          );
        }
        ...
        // }
          ...
          const dyMer = dy / r;
          const onMeridian =
            Math.abs(dxMer * dxMer + dyMer * dyMer - 1) <= tol / r;
        ...
        // }
          ...
          const nearEllipse =
            Math.abs(ellipseVal - 1) <= tol / Math.max(rx, ry);
        ...
        // }
          ...
          const checkEdges = (points) => {
            for (let i = 0; i < points.length; i++) {
              const [x1, y1] = points[i];
              const [x2, y2] = points[(i + 1) % points.length];
              if (distanceToLine(point.x, point.y, x1, y1, x2, y2) <= tol)
                return true;
            }
            return false;
          };
        ...
        // }
          ...
          const onEllipseBoundary =
            Math.abs(valEllipse - 1) <= tol / Math.max(rx, ry);
    ...
    switch (lastShape.tool) {
      ...
      case "triangle": {
        ...
        if (bottomEdge > stageSize.height)
      ...
      case "trapezium": {
        ...
        if (leftTop < 0 || leftBottom < 0) {
          ...
          rightTop > stageSize.width ||
          rightBottom > stageSize.width
        ) {
          shiftX = Math.min(
            stageSize.width - rightTop,
            stageSize.width - rightBottom
          );
        }
      ...
      case "rhombus": {
        ...
        width = Math.min(
          width,
          xDir === 1 ? stageSize.width - lastShape.startX : lastShape.startX
        );
        height = Math.min(
          height,
          yDir === 1 ? stageSize.height - lastShape.startY : lastShape.startY
        );
  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-start bg-gray-50 p-4">
      {/* Whiteboard Container */}
      <div className="w-full max-w-5xl bg-white shadow-md rounded-md flex flex-col">
        {/* Header */}
  ...
  <div className="">
    ...
    <span className="text-[11px] mt-1">{eraserSize}px</span>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-3 gap-2 mb-3">
                      <button
                        ...
                        className={`p-2 border rounded hover:bg-blue-300 flex justify-center items-center ${
                          tool === "rectangle" ? "bg-blue-500 text-white" : ""
                        }`}
                      >
                        ▭
                      </button>
                      ...
                      <button
                        ...
                        className={`p-2 border rounded hover:bg-blue-300 flex justify-center items-center ${
                          tool === "triangle" ? "bg-blue-500 text-white" : ""
                        }`}
                      >
                        △
                      </button>
                      <button
                        ...
                        className={`p-2 border rounded hover:bg-blue-300 flex justify-center items-center ${
                          tool === "ellipse" ? "bg-blue-500 text-white" : ""
                        }`}
                      >
                        ⬭
                      </button>
                      <button
                        ...
                        className={`p-2 border rounded hover:bg-blue-300 flex justify-center items-center ${
                          tool === "pentagon" ? "bg-blue-500 text-white" : ""
                        }`}
                      >
                        ⬠
                      </button>
                      <button
                        ...
                        className={`p-2 border rounded hover:bg-blue-300 flex justify-center items-center ${
                          tool === "hexagon" ? "bg-blue-500 text-white" : ""
                        }`}
                      >
                        ⬡
                      </button>
                      ...
                      <button
                        ...
                        className={`p-2 border rounded hover:bg-blue-300 flex justify-center items-center ${
                          tool === "rhombus" ? "bg-blue-500 text-white" : ""
                        }`}
                      >
                        ◇
                      </button>
                      ...
                      <button
                        ...
                        className={`p-2 border rounded hover:bg-blue-300 flex justify-center items-center ${
                          tool === "star" ? "bg-blue-500 text-white" : ""
                        }`}
                      >
                        ☆
                      </button>
                      ...
                      <button
                        ...
                        className={`p-2 border rounded hover:bg-blue-300 flex justify-center items-center ${
                          tool === "trapezium" ? "bg-blue-500 text-white" : ""
                        }`}
                      >
                        ⏢
                      </button>
                      <button
                        ...
                        className={`p-2 border rounded hover:bg-blue-300 flex justify-center items-center ${
                          tool === "square" ? "bg-blue-500 text-white" : ""
                        }`}
                      >
                        ☐
                      </button>
                    ...
                    <div className="grid grid-cols-3 gap-2 mb-3">
                      <button
                        ...
                        className={`p-2 border rounded hover:bg-green-300 flex justify-center items-center ${
                          tool === "line" ? "bg-green-500 text-white" : ""
                        }`}
                      >
                        <FaSlash />
                      </button>
                      <button
                        ...
                        className={`p-2 border rounded hover:bg-green-300 flex justify-center items-center ${
                          tool === "arrow" ? "bg-green-500 text-white" : ""
                        }`}
                      >
                        ⟶
                      </button>
                      <button
                        ...
                        className={`p-2 border rounded hover:bg-green-300 flex justify-center items-center ${
                          tool === "dashed" ? "bg-green-500 text-white" : ""
                        }`}
                      >
                        -----
                      </button>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      <button
                        ...
                        className={`p-2 border rounded hover:bg-red-300 flex justify-center items-center ${
                          tool === "cube" ? "bg-red-500 text-white" : ""
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`p-2 border rounded hover:bg-red-300 flex justify-center items-center ${
                          tool === "sphere" ? "bg-red-500 text-white" : ""
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`p-2 border rounded hover:bg-red-300 flex justify-center items-center ${
                          tool === "cylinder" ? "bg-red-500 text-white" : ""
                        }`}
                      >
                        <Cylinder size={20} />
                      </button>
                      ...
                      <button
                        ...
                        className={`p-2 border rounded hover:bg-red-300 flex justify-center items-center ${
                          tool === "cone" ? "bg-red-500 text-white" : ""
                        }`}
                      >
                        <Cone size={20} />
                      </button>
                      ...
                      <button
                        ...
                        className={`p-2 border rounded hover:bg-red-300 flex justify-center items-center ${
                          tool === "hemisphere" ? "bg-red-500 text-white" : ""
                        }`}
                      >
                        ◑
                      </button>
                      ...
                      <button
                        ...
                        className={`p-2 border rounded hover:bg-red-300 flex justify-center items-center ${
                          tool === "pyramid" ? "bg-red-500 text-white" : ""
                        }`}
                      >
                        <Pyramid size={20} />
                      </button>
        ...
        {/* Canvas */}
        <div className="w-full h-[500px] rounded-b-md shadow-inner border-t border-gray-200">
          <Stage
                        ...
                        onTransformEnd={(e) => {
                          ...
                          updatedShapes[i] = {
                            ...
                            bottomWidth: Math.max(
                              5,
                              shape.bottomWidth * uniformScale
                            ),
                            height: Math.max(5, shape.height * uniformScale),
                          };
