//Beow code supporrts both photo and shape selectable, drag
...
const ImageShape = ({ shape, isSelected, onSelect, onChange }) => {
  const [img] = useImage(shape.src); // ✅ hook is always stable here
  return (
    <Image
      image={img}
      x={shape.x}
