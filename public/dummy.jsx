    ...
    if (tool === "eraser") {
      ...
      for (let i = shapes.length - 1; i >= 0; i--) {
        ...
        // }
         ...
         else if (shape.tool === "arrow" || shape.tool === "dashed" || shape.tool === "line") {
  if (shape.points && shape.points.length >= 4) {
                    ...
                    return (
                      <Line
                        ...
                        onTransformEnd={(e) => {
                          ...
                          // ✅ use average scale so resize works both directions
                          ...
                          newShapes[i] = {
                            ...
                            x: node.x(),
                            y: node.y(),
                            radius: Math.max(5, shape.radius * scale), // shrink & grow uniformly
                            rotation: node.rotation(),
                          };
                    ...
                    return (
                      <Line
                        ...
                        onTransformEnd={(e) => {
                          ...
                          // ✅ uniform scaling factor (average works well)
                          const scale = (scaleX + scaleY) / 2;
                          ...
                          const updated = {
                            ...
                            x: node.x(),
                            y: node.y(),
                            radius: Math.max(5, shape.radius * scale), // resizes uniformly
                            rotation: node.rotation(),
                          };
                          ...
                          // reset transform so it doesn't accumulate
                          node.scaleX(1);
                          node.scaleY(1);
                        }}
                        onDragEnd={(e) => handleDragEnd(e, i)}
        ...
        return (
          <>
            ...
            <Line
              points={[
                0, 0,             // apex
                -w * dirX, h * dirY, // left base
                w * dirX, h * dirY,  // right base
                0, 0
              ]}
              stroke={shape.color}
              strokeWidth={shape.size}
