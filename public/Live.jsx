...
const ImageShape = ({ shape, index, onSelect, onChange, tool, handleDragEnd, shapes, pushToHistory }) => {
  ...
  return (
    <KonvaImage
      ...
      onTransformEnd={(e) => {
        ...
        // 🔑 Save in history
        const updatedShapes = shapes.map((s) => (s.id === shape.id ? updated : s));
...
const isShapeTool = (tool) =>
  ["rectangle", "circle", "triangle", "square", "hexagon", "pentagon","ellipse", "rhombus", "trapezium", "line", "arrow", "dashed", "star", "cube", "sphere", "cone", "hemisphere", "cylinder", "pyramid"].includes(tool);
    ...
    <span className="text-[11px] mt-1">{eraserSize}px</span>
          ...
          <div className="relative flex flex-col items-center">
            ...
            //   onClick={() => setShowShapes(!showShapes)}
              onClick={() => setActivePanel(prev => (prev === "shapes" ? null : "shapes"))}
              className={`p-2 rounded-full ${
                [
                  "rectangle",
                  "line",
